...
bool status_set = 0;
float minedge_x = (-(float)celllength),minedge_y = (-(float)celllength/2),maxedge_x = 0,maxedge_y = ((float)celllength/2),crosscell_x,crosscell_y,edgepoint_x,edgepoint_y,robot_body_x = 0.20,robot_body_y = 0.20;  //wall_follow parameters
